...
export const EN = {
  ...
  research: {
    ...
    areas: [
      ...
      { title: 'Evidence & Contradiction', desc: 'We keep supporting evidence, conflicting evidence, provenance, confidence, and unresolved questions together instead of flattening them into a premature verdict.' },
      { title: 'Model Welfare & Prompt Injection', desc: 'We study the behaviour, boundaries, failure modes, and dignity of intelligent systems — from jailbreak pressure to signs of distress.' },
    ],
  },
