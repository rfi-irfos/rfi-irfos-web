  ...
  squad: {
    ...
    agents: {
      atlas: {
        ...
        monitors: ['What every agent is finding', 'Which alerts overlap', "What's urgent vs. what can wait", 'Where agents depend on each other', 'How fast each agent responds', 'Whether an agent has gone silent'],
        detects: ['Conflicting reports from different agents', 'Duplicate alerts for the same issue', 'Priorities that are out of date', 'Bottlenecks between agents', 'An agent stuck or timing out', 'Two agents chasing the same problem'],
        output: ['One ranked to-do list instead of ten alerts', 'A clear next action', 'Escalation when something can’t wait', 'A record of what was decided and why', 'A weekly summary of what mattered', 'A single dashboard instead of eight inboxes'],
      },
      argus: {
        ...
        monitors: ['Competitor announcements', 'Company mentions and press', 'Public sentiment shifts', 'Ownership and leadership changes', 'Hiring and layoff announcements', 'Product launches and pricing changes'],
        detects: ['A competitor launching something new', 'A sudden spike or drop in attention', 'Conflicting information about a company', 'Early signs of a market shift', 'A competitor entering your market', 'A key employee leaving quietly'],
        output: ['A same-day alert, not a weekly digest', 'Who changed, what changed, and when', 'A short brief you can act on', 'A history of what happened and when', 'A competitor watchlist you control', 'A weekly market-movement summary'],
      },
      kopernikus: {
        ...
        monitors: ['Open grant programs', 'Investor activity in your sector', 'New funding rounds', 'Application deadlines', 'Government subsidy programs', 'Accelerator and incubator cohorts'],
        detects: ['A grant you actually qualify for', 'An investor backing similar companies', 'A closing deadline you might miss', 'Changed eligibility rules', 'A program matching your exact stage', 'Co-funding requirements you can meet'],
        output: ['A shortlist of real opportunities, not a database dump', 'Deadline reminders before it’s too late', 'Who’s investing in your space right now', 'A one-page brief per opportunity', 'A ranked list by fit and deadline', 'Direct links to the application page'],
      },
      janus: {
        ...
        monitors: ['Where a claim came from', 'When evidence was last verified', 'Citation and source chains', 'Contradictions between sources', 'Internal reports and decks', 'External press and citations'],
        detects: ['A claim with no real source behind it', 'Outdated information still being used', 'Two sources disagreeing with each other', 'A broken chain of evidence', 'A number that changed without explanation', 'A claim copied without checking it'],
        output: ['A source you can actually check', 'A verified fact, not a guess', 'An audit trail for every claim', 'A flag before something goes public unverified', 'A "verified as of" date on every fact', 'A ready answer for "where did this come from?"'],
      },
      mirror: {
        ...
        monitors: ['What was promised or planned', 'What is actually happening', 'Policy and rule compliance', 'Outcomes versus targets', 'Team velocity versus commitments', 'Customer-facing promises versus delivery'],
        detects: ['A team quietly working around the plan', 'A metric drifting off target', 'A rule being bent without anyone noticing', 'A gap between what was said and what was done', 'A missed deadline nobody flagged', 'A metric quietly redefined to look better'],
        output: ['An early warning, not a post-mortem', 'A clear before/after comparison', 'A running integrity score', 'A record for when someone asks "what happened?"', 'A weekly drift summary, not a surprise', 'A trend line before it becomes a crisis'],
      },
      daedalus: {
        ...
        monitors: ['Original requirements', 'What was actually built', 'Test coverage', 'Sign-off criteria', 'Definition of "done" per ticket', 'Deployment and rollout status'],
        detects: ["A feature marked done that isn't", 'A requirement quietly dropped', 'Missing tests for a critical path', 'A regression nobody flagged', 'A feature shipped without its tests', 'Documentation that doesn\'t match the build'],
        output: ['A pass/fail per requirement, not a vibe', 'Proof of completion you can show a client', "A list of what's actually still open", 'A regression alert before launch', 'A launch checklist, actually checked', 'Sign-off you can point to later'],
      },
      lynx: {
        ...
        monitors: ['Google search rankings', 'SEO and keyword performance', 'Duplicate or thin content', 'How your brand shows up in AI search results', 'Backlinks and referring domains', 'Local and map-pack listings'],
        detects: ['Pages competing against each other for the same keyword', "Content search engines can't properly index", "Your brand confused with someone else's", 'A ranking drop before you notice the traffic loss', 'A page that used to rank and no longer does', 'Missing schema markup search engines expect'],
        output: ['A prioritized list of SEO fixes', 'Keyword and ranking reports', 'A clear "fix this first"', 'Alerts when visibility drops', 'A technical SEO audit, not just keywords', 'A month-over-month traffic comparison'],
      },
      nyx: {
        ...
        monitors: ['Your attack surface', 'Third-party dependencies', 'Configuration and access settings', 'Exposed credentials', 'Open ports and exposed services', 'SSL/TLS certificate health'],
        detects: ['Known vulnerabilities in your dependencies', 'Misconfigured access controls', 'Leaked API keys or passwords', 'Outdated software with known exploits', 'An expired or misconfigured certificate', 'A dependency with a public CVE'],
        output: ['A ranked list of what to fix first', 'A report you can hand to your dev team', 'A plain-language risk explanation', 'A disclosure-ready writeup', 'A CVSS-style severity score per finding', 'A fix timeline you can commit to'],
      },
    },
    howItConnects: {
      eyebrow: 'Integration',
