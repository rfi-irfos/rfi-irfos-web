...
export const EN = {
  ...
  appPrivacy: {
    ...
    comparisonRows: [
      ...
      { classic: 'Your renewal risk sits in a support ticket, a sales note, and a slipping usage graph, three different systems, and nobody connects them until the customer has already left.', rfiLabel: 'Business intelligence', rfi: 'operational, commercial and behavioural signals scattered across systems are connected into one picture, so risk and opportunity surface before the outcome does, buried under everything else instead of lost in it.' },
    ],
    cta: 'Ping us!',
  },
