...
export const EN = {
  ...
  pricing: {
    ...
    web: [
      { tier: 'Full Build', hook: 'The complete custom build - no template, no page builder.', desc: 'You get a fully custom-built website or platform: multi-page, with a content editor your team can actually use, and a backend that grows with your operation instead of hitting a wall.\n\nWe scope the build with you in the first week after payment: which integrations you need, whether a dedicated Rust backend makes sense, how deep authentication has to go. Built by the same team that audits apps for security, so it is clean by default, not an afterthought.\n\nNo page-builder lock-in: you own the code and can take it anywhere. For organizations where the website is the business, not a brochure.', delivery: '14–28 calendar days, depending on scope.' },
      { tier: 'Native App Bundle', hook: 'Real native apps for Android and iPhone, on the same backend as your Full Build.', desc: 'You get real native Android and iPhone apps, not a web wrapper dressed up as one, built on the same backend as your Full Build project.\n\nWe also handle Play Store and App Store submission, exactly where most builds get stuck.\n\nScoped as an extension to the Full Build, not a separate project with its own infrastructure.', delivery: '14–28 calendar days, alongside the Full Build.' },
      { tier: 'Ongoing Care & Iteration', hook: 'Continuous upkeep and small improvements after launch, no slow rot.', desc: 'You get a steady rhythm of updates, security patches, and small improvements once your site is live - a dedicated contact who already knows your build.\n\nThat means a panic call never has to start with explaining your own setup.\n\nStarts the moment your Full Build goes live, no separate onboarding.', delivery: 'Ongoing engagement; first check-in within 14 calendar days.' },
      { tier: 'Enterprise & Compliance', hook: 'NDA, dedicated infrastructure, and priority handling, for organizations with their own compliance requirements.', desc: 'You get dedicated infrastructure instead of shared resources, an NDA before the project starts, and priority access to our team for everything that follows.\n\nWe scope the exact requirements directly with your legal and IT teams instead of guessing in advance.\n\nFor organizations where standard hosting or a shared backend is not an option.', delivery: 'User-specific timeline, aligned after kick-off.' },
    ],
    mobile: [
      { tier: 'Maintenance Retainer', hook: "Steady patches and dependency upkeep, so your app doesn't rot.", desc: 'You get a steady rhythm of patches, app-store compliance monitoring so a policy change never catches you off guard, and clean dependency upkeep so old libraries do not become tomorrow\'s emergency.\n\nOne named contact and priority response; first review lands within a week of payment.\n\nUpkeep you never have to think about.', delivery: 'Ongoing engagement; first patch within 14 calendar days.' },
      { tier: 'APK Review & Bugfix', hook: 'Send your build, get root-level answers in one week.', desc: 'You send the build. We decompile it, read the bytecode, and trace what it does at runtime. Android and iPhone.\n\nWe identify crashes and real weak spots, then hand you concrete guidance for fixing each one, at a fixed scope with a one-week turnaround from the day you send the build.\n\nA clear answer fast, instead of a six-week audit you were not braced for.', delivery: '1 week / 7 calendar days.' },
