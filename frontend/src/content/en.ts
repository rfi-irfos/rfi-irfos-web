...
export const EN = {
  ...
  pricing: {
    ...
    market: [
      { tier: 'Ecosystem Snapshot', hook: 'One question. One evidenced answer. From a corpus nobody else has.', desc: 'Other firms write you a report about one vendor. We answer a question against the whole ecosystem: hundreds of decompiled apps, checked at source-code level, not assembled from press releases or privacy policies.\n\nYou ask. We run it against nine intelligence layers - Code, SDK, Data-Flow, Tracker, Privacy, Supply-Chain, Competitive, Market, Security - and deliver an evidenced answer, not a guess.\n\nThe same corpus our public disclosures come from. If a competitor shows up in it, we know first - now you can too.', delivery: '14 calendar days.' },
      { tier: 'Competitive Intelligence', hook: 'Your competitors\' code. Not their press releases.', desc: 'What competitors claim publicly and what their code actually does almost never match. We show the real picture: which SDKs they actually ship, where their privacy behaviour diverges from the published policy, where their architecture is structurally weak.\n\nBenchmarked across six layers of the corpus - code, SDK, data-flow, tracker, privacy, supply-chain - so the gap you can exploit comes from evidence, not a guess in the boardroom.\n\nThe same corpus we use for disclosures. No one on the other side knows they\'re being looked at.', delivery: '14 calendar days.' },
      { tier: 'Sector Intelligence Report', hook: 'The whole sector, mapped. Refreshed every quarter, before anyone moves.', desc: 'A snapshot is out of date the moment it\'s printed. You get the risk profile of every major player in your sector, across all nine intelligence layers, in numbers instead of claims - refreshed every quarter, so you see where the market is heading, not just where it stood.\n\nFirst report within 14 calendar days. After that, the clock runs for you, not against you.', delivery: '14 calendar days, quarterly thereafter.' },
      { tier: 'Ongoing Intelligence Briefing', hook: 'A dedicated analyst watches your sector. Even when you\'re not.', desc: 'A competitor rarely makes just one move public - a funding round, a security incident, an SDK swap. You find out the day it happens, not weeks later in a newsletter.\n\nA dedicated analyst who knows your field watches the corpus for you: one briefing a month, an immediate alert on movement. Assigned within a week of payment, first briefing lands by the end of month one.', delivery: 'First briefing within 14 calendar days, then monthly.' },
    ],
  },
