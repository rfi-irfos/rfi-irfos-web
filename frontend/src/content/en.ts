  ...
  causalChains: {
    ...
    chains: [
      ...
      },
      {
        ...
        icon: 'coin',
        nodes: [
          'A clean-energy subsidy is reduced',
          'project returns fall',
          'a developer pauses a bid',
          'a turbine order is deferred',
          'a supplier backlog eases',
          'a grid-interconnection slot opens',
          'a utility revises its plan',
          'a carbon target slips',
          'a permit timeline extends',
          'financing terms tighten',
          'a rival technology looks better',
          'a workforce is downsized',
          'a region loses investment',
          'an emissions path bends',
      ...
      },
      {
        ...
        icon: 'train',
        nodes: [
          'A rail line is closed',
          'bulk wagons are stuck',
          'a mine output backs up',
          'trucking is substituted',
          'road wear accelerates',
          'a highway corridor congests',
          'hault cost rises per ton',
          'a port shipment misses a window',
          'a vessel sails partially loaded',
          'a freight rate adjusts',
          'a contract penalty accrues',
          'a backup route is built',
          'a maintenance backlog grows',
          'a mode shift is studied',
          'the corridor is rerated',
        ],
      },
    ],
  },
