...
export const EN = {
  ...
  research: {
    ...
    areas: [
      ...
      { title: 'Evidence & Contradiction', desc: 'Real evidence rarely agrees with itself, so supporting claims, conflicting claims, provenance, confidence, and unresolved questions stay together here instead of getting flattened into a premature verdict.' },
      { title: 'Model Welfare & Prompt Injection', desc: 'Intelligent systems have boundaries and failure modes, and increasingly something worth calling dignity too. This area studies all three, from jailbreak pressure to signs of distress.' },
    ],
  },
