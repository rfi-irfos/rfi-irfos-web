...
export const EN = {
  ...
  research: {
    ...
    areas: [
      { title: 'Ethics & Minor Protection', desc: 'Ethics is not a footnote here — it is where the research starts. Consent, dignity, and exposure in systems built around people who cannot fully protect themselves, starting with children and young people: platforms, biometric and behavioural data, and the systems built around them.' },
      { title: 'Ternary AI & Computing', desc: 'Post-binary arithmetic is not an academic curiosity for us — it is the foundation everything else runs on: language models, compilers, and operating systems built with it natively, not bolted on afterward. Patent pending A50296/2026.' },
      { title: 'World Models & Cross-Domain Intelligence', desc: 'Most systems that track entities, relationships, evidence, and change keep their domains apart. Ours does not: one shared model, so a shift in one system is traceable into everywhere it actually connects.' },
      { title: 'Pattern Recognition & Impact Propagation', desc: 'A change rarely stays where it started — it moves through dependencies, bridges, bottlenecks, and every connected system downstream. Finding those recurring structures across domains is what this area is for.' },
      { title: 'Change & Anomaly Detection', desc: 'Not every shift matters, and not every anomaly is noise. This is the discipline of watching systems over time and telling the two apart: what changed, what is unusual, and which transitions actually deserve attention.' },
      ...
      { title: 'Evidence & Contradiction', desc: 'Real evidence rarely agrees with itself. Supporting claims, conflicting claims, provenance, confidence, and unresolved questions stay together here instead of getting flattened into a premature verdict.' },
      { title: 'Model Welfare & Prompt Injection', desc: 'Intelligent systems have boundaries, failure modes, and — increasingly — something worth calling dignity. This area studies all three, from jailbreak pressure to signs of distress.' },
    ],
  },
