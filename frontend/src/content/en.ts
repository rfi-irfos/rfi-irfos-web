...
export const EN = {
  ...
  pricing: {
    ...
    subheading: 'Five domains, one evidence-first, cross-domain Dingir world model behind all of them. Any engagement can combine multiple areas.',
    deliveryLabel: 'Delivery',
    domains: [
      { name: 'Intelligence',
        badge: 'Market intelligence \u00b7 competitor intelligence \u00b7 claims verification',
        scope: 'Market intelligence, competitor intelligence, vendor investigations, claims verification, entity research, cross-domain relationships and emerging risks.',
        bring: 'A company, market, competitor, vendor, claim, investment or decision where the available information is incomplete, conflicting or too easy to take at face value.',
        we: 'Collect and verify evidence across public records, technical systems, historical information and external sources. We map entities and relationships, test competing explanations and connect relevant observations inside Dingir, our queryable data warehouse and world model. What cannot be established stays uncertain rather than being turned into a confident assumption.',
        receive: 'A sourced intelligence picture showing what we can establish, what remains unknown, what contradicts the original claim, which relationships matter and where the actual exposure, opportunity or emerging risk sits.',
        cta: 'Bring us the question \u2192', delivery: 'Delivered within 14 calendar days.' },
      { name: 'Security',
        badge: 'Root-level investigation \u00b7 red teaming \u00b7 adversarial testing',
        scope: 'Root-level security investigation, cyberdefense, red teaming, penetration testing, vulnerability research, attack-surface analysis, data-flow reconstruction, privacy analysis and adversarial testing.',
        bring: 'An application, binary, API, backend, cloud environment, infrastructure, vendor or cybersecurity claim that needs to be tested against reality.',
        we: 'Go below the documentation. We inspect implementations, decompile where necessary, trace data flows and trust boundaries, reconstruct attack paths and test the assumptions your existing security picture depends on. Our investigations can span application code, mobile systems, APIs, cloud infrastructure, authentication, third-party dependencies and external attack surface.',
        receive: 'A technically evidenced picture of what the system actually does, where it can fail or be abused, how an attacker could move through it, what the consequences are and which findings actually matter for your security posture.',
        cta: 'Put it to the test \u2192', delivery: 'Delivered within 14 calendar days.' },
      { name: 'Data',
        badge: 'Queryable data warehouse \u00b7 evaluation infrastructure \u00b7 full provenance',
        scope: 'Queryable data warehouses, behavioural datasets, SDK and tracker graphs, agent trajectories, AI training and evaluation data, safety datasets, causal world-state data and provenance infrastructure.',
        bring: 'A dataset, model, agent, telemetry stream, application, evaluation problem or domain where the available data is incomplete, poorly structured, difficult to reproduce or disconnected from its source.',
        we: 'Build the collection, transformation, labelling, evaluation and provenance layer around the actual problem. We can connect application behaviour, SDKs, trackers, telemetry, agent trajectories and external world-state data into a queryable structure while preserving where each observation came from, how it was produced and how it was validated.',
        receive: 'Versioned, traceable data and evaluation infrastructure ready for research, model training, agent evaluation, security analysis or production use, with the evidence chain preserved instead of flattened into a dataset nobody can properly audit later.',
        cta: 'Bring us the data \u2192', delivery: 'Delivered within 14 calendar days.' },
      { name: 'Business & Market',
        badge: 'Market & competitor intelligence \u00b7 counterparty analysis \u00b7 regulatory signals',
        scope: 'Competitor intelligence, supplier intelligence, market mapping, corporate research, counterparty analysis, investment intelligence, regulatory developments, infrastructure dependencies and emerging risks.',
        bring: 'A market, competitor, supplier, investment, acquisition, expansion decision or business risk that cannot be understood from one spreadsheet, pitch deck or market report.',
        we: 'Connect company-level evidence with market signals, public records, technical infrastructure, regulatory developments, external events and historical changes. Dingir lets us query relationships across domains instead of treating every company, market and event as an isolated data point.',
        receive: 'A decision picture showing what is happening, what is connected, where the exposure sits, which assumptions survive investigation and what could materially change the situation.',
        cta: 'Challenge the assumption \u2192', delivery: 'Delivered within 14 calendar days.' },
      { name: 'Engineering',
        badge: 'Architecture & implementation \u00b7 digital twin verification \u00b7 spec vs. reality',
        scope: 'Software architecture, backend systems, cloud infrastructure, APIs, data pipelines, Digital Twins, IoT/IIoT and Digital Thread, investigated directly in Python, Rust, Go, Java, JavaScript/TypeScript and mobile stacks.',
        ...
        cta: 'Show us the system \u2192', delivery: 'Delivered within 14 calendar days.' },
    ],
  },
  ...
  journey: {
    ...
    steps: [
      ...
      { stage: 'Collect', body: 'We work from the underlying material, not from somebody else\'s summary. We inspect the systems, code, data and documents you provide and collect the external evidence the question actually requires.\n\nThat can mean decompiling an application, tracing data flows, examining APIs and cloud infrastructure, querying datasets, checking public records, mapping companies and relationships or reconstructing what changed over time. Every relevant finding gets a source.' },
      { stage: 'Investigate', body: 'Our engineers, researchers and AI agents work through the evidence. We test claims, reconstruct behaviour, follow dependencies, compare competing explanations and investigate contradictions.\n\nDepending on the engagement, this can include red teaming, vulnerability research, cyberdefense, path analysis, market intelligence, competitor research, data analysis or technical verification. Relevant evidence is connected inside Dingir, our queryable data warehouse and world model, so findings from different sources can be examined together instead of sitting in separate reports.' },
      { stage: 'Verify', body: 'Nothing becomes a finding because one source or one agent said so. Our human team reviews the investigation, challenges the conclusions and checks important claims against the underlying evidence.\n\nWe distinguish between what is observed, reproduced, corroborated, inferred, contradicted or still unknown. If the evidence does not support a conclusion, we say so. The result has to survive scrutiny before it reaches you.' },
      { stage: 'Deliver', body: 'You receive the investigation in a form you can actually use: the findings, the evidence behind them, the relevant relationships, the remaining uncertainty and what the result means for the decision you brought us.\n\nDepending on the engagement, that can be a technical investigation, security assessment, intelligence report, data deliverable, engineering reconstruction or a cross-domain investigation through Dingir. Because the evidence remains structured, the next question can start from what we already established instead of starting from zero.' },
    ],
  },
  ...
  worldModel: {
    ...
    comparison: {
      eyebrow: 'How DINGIR Differs',
      heading: 'Language model vs. agent vs. world model',
      sub: 'Three things that sound similar and are not. Know which one you are actually talking to.',
    ...
    reasoningIntro: {
      eyebrow: 'In Practice', heading: 'How DINGIR reasons',
      sub: 'Traced causal chains, and the live events feeding them, side by side.',
    },
    chainsPreview: {
  ...
  squad: {
    ...
    overview: {
      eyebrow: 'The Lineup',
      heading: 'Selected From Our Own Production',
      sub: 'Eight specialized agents, each built around one clear question. Pick the one you need, or start with the whole squad.',
      columns: { monitors: 'Monitors', detects: 'Detects', output: 'You get' },
    },
    agents: {
      atlas: {
        mission: 'Tells you what needs your attention first.',
        domain: 'Orchestration & Prioritization',
        jobTitle: 'Strategic Operations Lead',
        description: "Atlas is the agent you call when signals arrive from every direction and someone has to decide what matters most, right now. It ranks urgency across every agent's output so nothing critical gets buried under noise.",
        monitors: ['What every agent is finding', 'Which alerts overlap', "What's urgent vs. what can wait", 'Where agents depend on each other', 'How fast each agent responds', 'Whether an agent has gone silent', 'Which deadlines are closing in', 'Where the same task is being done twice'],
        detects: ['Conflicting reports from different agents', 'Duplicate alerts for the same issue', 'Priorities that are out of date', 'Bottlenecks between agents', 'An agent stuck or timing out', 'Two agents chasing the same problem', 'A decision stalled waiting on one person', 'A task with no clear owner'],
        output: ['One ranked to-do list instead of ten alerts', 'A clear next action', 'Escalation when something can’t wait', 'A record of what was decided and why', 'A weekly summary of what mattered', 'A single dashboard instead of eight inboxes', 'A named owner for every open item', 'A workload view across the whole squad'],
      },
      argus: {
        mission: 'Finds out when a competitor makes a move — the same day it happens.',
        domain: 'Market & Attention Intelligence',
        jobTitle: 'Market & Communications Intelligence',
        description: "Argus is the agent you call when a competitor makes a move and you need to know the same day, not weeks later. It watches your market continuously and flags what actually changed.",
        monitors: ['Competitor announcements', 'Company mentions and press', 'Public sentiment shifts', 'Ownership and leadership changes', 'Hiring and layoff announcements', 'Product launches and pricing changes', 'Trade press and industry newsletters', 'Conference talks and published roadmaps'],
        detects: ['A competitor launching something new', 'A sudden spike or drop in attention', 'Conflicting information about a company', 'Early signs of a market shift', 'A competitor entering your market', 'A key employee leaving quietly', 'A narrative forming before it reaches mainstream press', 'A partnership or acquisition rumour gaining weight'],
        output: ['A same-day alert, not a weekly digest', 'Who changed, what changed, and when', 'A short brief you can act on', 'A history of what happened and when', 'A competitor watchlist you control', 'A weekly market-movement summary', 'A quarterly competitive landscape you can present', 'Talking points before a journalist calls'],
      },
      kopernikus: {
        mission: 'Finds out which grants and investors you actually qualify for.',
        domain: 'Funding & Capital Intelligence',
        jobTitle: 'Grants & Fundraising Intelligence',
        description: "Kopernikus is the agent you call when a grant or investor deadline is closing and there is no time to search for it yourself. It finds funding and capital opportunities that actually match where you are.",
        monitors: ['Open grant programs', 'Investor activity in your sector', 'New funding rounds', 'Application deadlines', 'Government subsidy programs', 'Accelerator and incubator cohorts', 'Consortium calls still looking for partners', 'Changes to eligibility and funding rules'],
        detects: ['A grant you actually qualify for', 'An investor backing similar companies', 'A closing deadline you might miss', 'Changed eligibility rules', 'A program matching your exact stage', 'Co-funding requirements you can meet', 'A call where the consortium is still missing a partner', 'A programme quietly reopening after a pause'],
        output: ['A shortlist of real opportunities, not a database dump', 'Deadline reminders before it’s too late', 'Who’s investing in your space right now', 'A one-page brief per opportunity', 'A ranked list by fit and deadline', 'Direct links to the application page', 'A reusable answer bank for recurring application questions', 'A funding pipeline you can show a board'],
      },
      janus: {
        mission: 'Catches the claim in your report that nobody actually checked.',
        domain: 'State & Evidence Steward',
        jobTitle: 'Knowledge & Evidence Manager',
        description: 'Janus is the agent you call when a claim in a report needs a real source behind it before someone repeats it. It checks evidence chains so "says who?" has a ready answer.',
        monitors: ['Where a claim came from', 'When evidence was last verified', 'Citation and source chains', 'Contradictions between sources', 'Internal reports and decks', 'External press and citations', 'Which documents are the current version', 'Which sources have gone offline'],
        detects: ['A claim with no real source behind it', 'Outdated information still being used', 'Two sources disagreeing with each other', 'A broken chain of evidence', 'A number that changed without explanation', 'A claim copied without checking it', 'A statistic still circulating years after it was retracted', 'A slide reused with numbers nobody re-checked'],
        output: ['A source you can actually check', 'A verified fact, not a guess', 'An audit trail for every claim', 'A flag before something goes public unverified', 'A "verified as of" date on every fact', 'A ready answer for "where did this come from?"', 'One approved source per recurring figure', 'A citation pack for reports and filings'],
      },
      mirror: {
        mission: 'Tells you when a team is quietly missing what was promised.',
        domain: 'Integrity & Drift Detection',
        jobTitle: 'Quality & Integrity Auditor',
        description: "Mirror is the agent you call when a plan and what's actually happening have quietly stopped matching. It flags the drift early, before it turns into a real problem.",
        monitors: ['What was promised or planned', 'What is actually happening', 'Policy and rule compliance', 'Outcomes versus targets', 'Team velocity versus commitments', 'Customer-facing promises versus delivery', 'Budget spent against budget planned', 'Process steps that get skipped under pressure'],
        detects: ['A team quietly working around the plan', 'A metric drifting off target', 'A rule being bent without anyone noticing', 'A gap between what was said and what was done', 'A missed deadline nobody flagged', 'A metric quietly redefined to look better', 'A workaround that has become the default process', 'A recurring exception nobody re-approved'],
        output: ['An early warning, not a post-mortem', 'A clear before/after comparison', 'A running integrity score', 'A record for when someone asks "what happened?"', 'A weekly drift summary, not a surprise', 'A trend line before it becomes a crisis', 'Evidence ready for an internal or external audit', 'A short list of what to correct first'],
      },
      daedalus: {
        mission: 'Catches the feature marked "done" that secretly isn\'t.',
        domain: 'Implementation & Completion Intelligence',
        jobTitle: 'Delivery Verification Lead',
        description: 'Daedalus is the agent you call when something gets marked "done" and you need to know if that is actually true. It verifies requirements and tests before a gap ships to a customer.',
        monitors: ['Original requirements', 'What was actually built', 'Test coverage', 'Sign-off criteria', 'Definition of "done" per ticket', 'Deployment and rollout status', 'Open defects against the release criteria', 'Documentation and handover material'],
        detects: ["A feature marked done that isn't", 'A requirement quietly dropped', 'Missing tests for a critical path', 'A regression nobody flagged', 'A feature shipped without its tests', 'Documentation that doesn\'t match the build', 'Scope added late without a matching test', 'A dependency shipped in a different version than tested'],
        output: ['A pass/fail per requirement, not a vibe', 'Proof of completion you can show a client', "A list of what's actually still open", 'A regression alert before launch', 'A launch checklist, actually checked', 'Sign-off you can point to later', 'Release notes grounded in what actually shipped', 'A go/no-go recommendation with reasons'],
      },
      lynx: {
        mission: 'Checks whether people can actually find you online.',
        domain: 'Visibility & SEO Intelligence',
        jobTitle: 'Online Visibility & SEO Expert',
        description: "Lynx is the agent you call when you need to know whether people can actually find you online. It monitors search visibility and fixes the SEO gaps costing you traffic.",
        monitors: ['Google search rankings', 'SEO and keyword performance', 'Duplicate or thin content', 'How your brand shows up in AI search results', 'Backlinks and referring domains', 'Local and map-pack listings', 'Core Web Vitals and page speed', 'Competitor pages outranking yours'],
        detects: ['Pages competing against each other for the same keyword', "Content search engines can't properly index", "Your brand confused with someone else's", 'A ranking drop before you notice the traffic loss', 'A page that used to rank and no longer does', 'Missing schema markup search engines expect', 'Broken links and redirect chains bleeding authority', 'A competitor taking a featured snippet from you'],
        output: ['A prioritized list of SEO fixes', 'Keyword and ranking reports', 'A clear "fix this first"', 'Alerts when visibility drops', 'A technical SEO audit, not just keywords', 'A month-over-month traffic comparison', 'A content plan tied to real search demand', 'A before/after record of every fix applied'],
      },
      nyx: {
        mission: 'Finds security gaps before someone else does.',
        domain: 'Security & Vulnerability Deep Scan',
        jobTitle: 'Cyberdefense & Vulnerability Expert',
        description: "Nyx is the agent you call when you need to know where your stack is exposed before someone else finds out. It scans for vulnerabilities and hands you a ranked list of what to fix first.",
        monitors: ['Your attack surface', 'Third-party dependencies', 'Configuration and access settings', 'Exposed credentials', 'Open ports and exposed services', 'SSL/TLS certificate health', 'Newly published CVEs affecting your stack', 'Public code and storage left open'],
        detects: ['Known vulnerabilities in your dependencies', 'Misconfigured access controls', 'Leaked API keys or passwords', 'Outdated software with known exploits', 'An expired or misconfigured certificate', 'A dependency with a public CVE', 'An unused account still holding live access', 'A subdomain pointing at a service you no longer own'],
        output: ['A ranked list of what to fix first', 'A report you can hand to your dev team', 'A plain-language risk explanation', 'A disclosure-ready writeup', 'A CVSS-style severity score per finding', 'A fix timeline you can commit to', 'Evidence for an ISO 27001 or NIS2 review', 'A re-test confirming the fix actually worked'],
      },
    },
    howItConnects: {
      eyebrow: 'Integration',
      heading: 'How It Connects',
      sub: 'Four steps from a raw signal in your systems to a verified action you can trust.',
      hint: 'Click any numbered step for detail.',
      zones: [
        { label: 'Your Systems', steps: [
          { icon: 'data', title: 'Your Data', body: 'Code, market feeds, funding databases, whatever the relevant agent needs to watch.' },
        ] },
        { label: 'Connect', steps: [
          { icon: 'mcp', title: 'MCP Server', body: 'Plug directly into your existing agent tooling.' },
          { icon: 'cli', title: 'CLI', body: 'Script it into your own pipelines and CI.' },
          { icon: 'dashboard', title: 'Dashboard', body: 'No integration needed, just log in.' },
        ] },
        { label: 'The Squad', steps: [
          { icon: 'process', title: 'Agent Processes', body: 'The right specialist picks it up and runs its check.' },
          { icon: 'crosscheck', title: 'Cross-Checked', body: "Verified against DINGIR's world model, not judged in isolation." },
        ] },
        { label: 'Delivery', steps: [
          { icon: 'deliver', title: 'Delivered', body: 'Back through the same channel: webhook, CLI output, or dashboard alert.' },
          { icon: 'act', title: 'You Act', body: 'One ranked, concrete next step, not more raw noise.' },
        ] },
      ],
    },
    needToKnow: {
      ...
      sub: 'Six questions we hear most often, and which agent answers each one.',
      cards: [
        { question: 'Who is moving?', body: 'Track markets, entities and attention in real time.', tags: ['argus', 'kopernikus', 'janus'] },
        { question: 'Is capital flowing?', body: 'Find grants, investors and funding opportunities.', tags: ['kopernikus', 'janus'] },
        { question: 'What is drifting?', body: 'Detect deviations between intent, behavior and outcome.', tags: ['mirror', 'janus', 'atlas'] },
        { question: 'Is it really done?', body: 'Verify implementation and requirement completion.', tags: ['daedalus', 'mirror', 'janus'] },
        { question: 'Are we visible?', body: 'Monitor visibility, SEO and search presence.', tags: ['lynx', 'argus'] },
        { question: 'Are we exposed?', body: 'Deep scan for vulnerabilities and attack surface.', tags: ['nyx', 'janus'] },
      ],
      requestAccess: 'Request Access →',
    },
    requestForm: {
      heading: 'Start with one agent.',
      description: 'No bundle required — request access to the agent you need, or the whole squad.',
      emailPlaceholder: 'Work email',
      companyPlaceholder: 'Company',
      submitIdle: 'Request Access', submitSending: 'Sending...', submitOk: 'Received. We’ll be in touch.',
      errorText: 'Something went wrong on our side. Reach us directly instead:',
      privacyNote: 'We respect your privacy. No spam. No sharing.',
      interestedPrefix: 'Interested in',
    },
  },
