...
export const EN = {
  ...
  hero: {
    ...
    identity: 'Regulated Austrian research institute. Ternary AI, security, governance, minor protection, and ecocentric technology. One team. Everything built in-house.',
    stats: {
  ...
  appPrivacy: {
    ...
    whatWeCheck: 'Permissions actually requested and used, where data flows once it leaves the device, which third-party SDKs are embedded and what they receive, and when tracking behaviour actually starts relative to consent.',
    whatYouGetHeading: 'What you get',
    whatYouGet: 'A data flow map of what the app actually does, a risk analysis of what that means for you, and the underlying findings behind both — in plain language first, technical detail available underneath.',
  ...
  journey: {
    ...
    steps: [
      { stage: 'Kickoff', body: "Scope gets locked, a named engineer is assigned, and whatever you're providing - a build, API access, a device - is exchanged through a secure channel. You know exactly who is doing the work and when it starts." },
      { stage: 'Analyse', body: 'The investigation itself, run against the same Sources and Methods principles that apply to every client: source-level testing, root-cause tracing, nothing accepted that only one person can reproduce.' },
      { stage: 'Review', body: 'Every finding is triaged and ranked by severity before it reaches you, in the same five-part format documented in our Methodology - what we found, what proves it, how we proved it, how sure we are, what to do about it.' },
      { stage: 'Delivery', body: 'You receive the findings in the format your tier defines - plain-language summary first, technical detail underneath - on the delivery window agreed at checkout.' },
      { stage: 'Follow-up', body: 'Once fixes ship, a retest confirms they actually closed the gap, where the tier includes one. For ongoing engagements, follow-up is also where the next audit cycle begins.' },
    ],
  },
