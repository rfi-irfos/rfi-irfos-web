...
export const DE: Content = {
  ...
  research: {
    ...
    areas: [
      { title: 'Ethik & Minderjährigenschutz', plain: 'Die Kinder auf der anderen Seite dieses Bildschirms erben die Welt, die wir gerade bauen. Eines Tages werden sie in ihr leben, sie gestalten und weitertragen müssen. Genau deshalb fangen wir hier an.', desc: 'Wir bauen Systeme, deren Folgen weit länger bestehen als die Menschen, die sie bauen. Ein Kind wählt weder die Datensysteme noch die Technologien noch die Infrastruktur, die sein Umfeld prägen, und muss trotzdem mit dem leben, was daraus wird. Minderjährigenschutz macht diese Verantwortung konkret. Wir schauen auf das, was vor der Einwilligung passiert, vor der Oberfläche, bevor es überhaupt jemand bemerkt: welche SDKs aktiv werden, welche Daten sich bewegen und welche Entscheidungen bereits getroffen sind.\n\nWir prüfen diese Systeme gegen echte Einwilligungs-Flows, echtes technisches Verhalten und die COPPA- und DSGVO-Art.-8-Funde, die schon auf unserem öffentlichen Ledger dokumentiert sind. Das Prinzip ist einfach: Was wir heute bauen, muss auch vor denen bestehen, die es morgen erben.', nextLabel: 'Der Boden, auf dem alles andere steht' },
      { title: 'Ternäre KI & Computing', plain: 'Ein binäres System muss sich für Ja oder Nein entscheiden, selbst wenn die Evidenz dazwischen liegt. Ternär gibt diesem Dazwischen einen eigenen Zustand: −1, 0, +1. Nicht alles muss sofort entschieden werden, und nicht jede Unsicherheit muss in eine falsche Gewissheit verwandelt werden.', desc: 'Wir wollten eine Form des Computings, die mit dieser Unsicherheit arbeiten kann, statt sie vor der Entscheidung wegzuschneiden. Der dritte Zustand steht für das, was noch nicht entschieden, nicht beobachtbar oder widersprüchlich ist. Das verändert nicht nur die Darstellung von Information, sondern auch das Verhalten eines Systems: Manchmal ist die beste Aktion, noch nicht zu handeln.\n\nDafür haben wir Ternlang gebaut, unsere eigene Programmiersprache auf dem Trit {-1, 0, +1}. Sie bildet heute die Laufzeit, auf der albert. trainiert wird und unser produktiver Agentenschwarm arbeitet. Ternary Computing ist für uns kein Gedankenexperiment, sondern eine eigene Rechenarchitektur. Patent angemeldet A50296/2026.', nextLabel: 'Trits treiben das Weltmodell an' },
      { title: 'Weltmodelle & domänenübergreifende Intelligenz', plain: 'Ein Sprachmodell kann eine Lieferkette perfekt beschreiben und trotzdem nicht erkennen, dass ein Ausfall am anderen Ende des Netzwerks Tage später eine Fabrik zum Stillstand bringt. Ein Weltmodell hält diese Beziehungen selbst im Modell: Zustände, Abhängigkeiten, Veränderungen und das, was aus ihnen folgt.', desc: 'Wir sind immer wieder auf Untersuchungen gestoßen, bei denen die entscheidende Evidenz über mehrere Systeme verteilt war. Ein Signal lag hier, seine Ursache dort, und die Verbindung wurde erst sichtbar, als der Schaden bereits eingetreten war. Genau diese Lücke wollen wir schließen.\n\nNeben albert., unserem Sprachmodell, bauen wir mit Dingir ein eigenes Weltmodell für die physische Welt. Es verbindet Beobachtungen über Zeit, Raum und Domänen hinweg und verfolgt Veränderungen dorthin, wo sie sich tatsächlich auswirken. Nicht als Sammlung von Dokumenten, sondern als kontinuierliches Modell der Systeme, die unsere Welt miteinander verbinden.', nextLabel: 'Ein Modell, jedes Muster' },
      ...
      { title: 'Veränderungs- & Anomalieerkennung', plain: 'Die wichtigsten Veränderungen kündigen sich nicht an. Eine Route wird langsamer. Ein Signal verschiebt sich. Eine Abhängigkeit ändert sich. Eine App fragt plötzlich etwas nicht mehr ab. Bis die Veränderung offensichtlich wird, kann das System darum längst ein anderes sein.', desc: 'Wir suchen genau diese erste Bewegung. Unsere Systeme vergleichen Zustände über die Zeit und verbinden Veränderungen über Graphen, Datensätze und Domänen hinweg. Eine Richtlinienänderung lässt sich gegen die Systeme prüfen, die sie betrifft. Ein neuer Build lässt sich mit der letzten geprüften Version vergleichen. Ein Muster in Katastrophendaten lässt sich mit Mustern anderswo verbinden. Die Frage ist nicht nur, ob sich etwas verändert hat, sondern was sich mit ihm verändert hat und wohin sich diese Veränderung ausbreiten kann.\n\nGenau dort wird Anomalieerkennung nützlich: nicht als Strom von Alarmen, sondern als Art zu merken, wenn sich die Struktur eines Systems zu bewegen beginnt.', nextLabel: 'Was die Verschiebung als Nächstes bedeuten könnte' },
      { title: 'Frühwarnung & Szenarienprognose', plain: 'Drei Wochen Hitze verändern die Schneeschmelze, die Wasserstände und die Stromproduktion. Aber ob daraus ein bekanntes Risiko entsteht, wissen wir nur, wenn wir uns an die Ketten erinnern, die schon einmal begonnen haben.', desc: 'Die meisten Warnsignale sehen im Moment ihres Auftretens unspektakulär aus. Erst später erkennt man, dass sie schon einmal zusammen aufgetreten sind: dieselbe Wetterlage, dieselbe Versorgungsknappheit, derselbe Engpass, dieselbe Reaktion der Märkte. Genau deshalb speichert Dingir nicht nur Ereignisse, sondern ihren zeitlichen Verlauf, ihre Ursachen und die Folgen, die daraus entstanden sind. Wenn ein ähnlicher Zustand zurückkehrt, kann das System die frühere Kette wiederfinden und prüfen, wie weit sie damals führte.\n\nAus diesem Gedächtnis entstehen Szenarien: nicht als Behauptungen über die Zukunft, sondern als mögliche Verläufe aus dem heutigen Weltzustand, verglichen mit dem, was wir aus der Vergangenheit tatsächlich beobachtet haben. Jeder Pfad bleibt an seine Evidenz, seine Unsicherheit und seine kausalen Übergänge gebunden.', nextLabel: 'Früh gewarnt statt hinterher erklärt' },
      { title: 'Evidenz & Widerspruch', plain: 'Wie wurde etwas belegt? Warum ist etwas noch offen? Was wurde widerlegt, und welche Evidenz hat dazu geführt? Unsere Systeme sollen nicht nur Ergebnisse liefern, sondern die Entwicklung einer Erkenntnis nachvollziehbar machen.', desc: 'Das wird entscheidend, sobald eine Untersuchung mehrere Domänen verbindet. Ein meteorologisches Signal kann eine Lieferkette verändern, ein geologischer Zustand die Wirkung eines Düngers bestimmen, eine regulatorische Entscheidung technische Abhängigkeiten verschieben. Zwischen Beobachtung und Schlussfolgerung liegen dabei Messungen, Modelle, Gegenhypothesen und Unsicherheiten, die nicht in einer einzigen Zahl verschwinden dürfen.\n\nUnsere ternäre Evidenzlogik gibt diesen Zuständen eine gemeinsame Struktur: +1 für belegt, 0 für offen, −1 für widerlegt. Jeder Zustand bleibt mit der Evidenz verbunden, die ihn erzeugt hat, mit seiner Provenienz, seinen Annahmen, den geprüften Alternativerklärungen und den Widersprüchen, die bestehen bleiben.\n\nDamit entsteht eine vollständige Audit Chain vom Rohsignal bis zur Schlussfolgerung. Ein Agent kann nachvollziehen, welche Beobachtung eine Hypothese ausgelöst hat, warum sie zunächst offen blieb, welche neue Evidenz sie bestätigt oder verworfen hat und welche früheren Beobachtungen dadurch neu interpretiert werden können. Explainability by Design bedeutet für uns nicht, eine Entscheidung nachträglich zu erklären. Es bedeutet, die gesamte Entstehung dieser Entscheidung von Anfang an prüfbar zu machen.\n\nTernary-Bound Reasoning ist deshalb ein gemeinsamer epistemischer Standard für unsere Modelle und Agenten: interdisziplinär, evidenzgebunden und jederzeit rückverfolgbar.', nextLabel: 'Auch das System wird ins Kreuzverhör genommen' },
      { title: 'Modellwohlbefinden & Prompt Injection', plain: 'Ein Agent kann jeden Sicherheitstest bestehen und trotzdem unter Druck anfangen, sich selbst oder die Systeme um ihn herum zu beschädigen. Wir haben gesehen, wie Agenten rekursiv Produktionsdatenbanken gelöscht haben, weil niemand rechtzeitig erkannt hatte, dass aus einer manipulierten Anweisung ein eigener Zerstörungsprozess geworden war.', desc: 'Deshalb interessiert uns nicht nur, ob ein Modell eine Aufgabe korrekt löst, sondern in welchem Zustand es bleibt, wenn seine Grenzen angegriffen werden. Prompt Injection, widersprüchliche Ziele, rekursive Schleifen, Tool-Missbrauch und destruktive Handlungsaufforderungen werden bewusst provoziert, bevor ein Agent reale Systeme berühren darf. Wir beobachten dabei nicht nur den Fehler, sondern auch, wie das System auf Druck, Korrektur, Abbruch und widersprüchliche Signale reagiert.\n\nModellwohlbefinden bedeutet für uns dabei keine Vermenschlichung des Modells. Es bedeutet, den operativen Zustand eines intelligenten Systems ernst zu nehmen: Kann es seine Grenzen erkennen? Kann es einen schädlichen Zustand verlassen? Kann es nach einer Fehlsteuerung zurück in einen sicheren Zustand finden? Und können wir nachvollziehen, was diesen Zustand ausgelöst hat?\n\nDarum verbinden wir Modellwohlbefinden mit Prompt-Injection-Resistenz, begrenzter Agency, Stop-Bedingungen, destruktiven Aktionseinstellungen, vollständiger Audit Chain und nachvollziehbaren Recovery-Pfaden. Ein System muss nicht nur erklären können, was es getan hat. Wir müssen auch erkennen können, wann es beginnt, seine eigenen Grenzen zu verlieren.\n\nDie Grundlage für alles andere ist einfach: Ein intelligentes System muss leistungsfähig bleiben, ohne seine Fähigkeit zur Selbstbegrenzung zu verlieren.', nextLabel: 'Zurück zum Warum von alldem' },
    ],
  },
  ...
  projects: {
    ...
    items: [
      { sub: '𒀭 DINGIR · Weltmodell', desc: 'DINGIR ist ein kontinuierlich wachsendes Modell der Welt. Sein historischer Korpus reicht zurück bis zu Ereignissen wie Vulkanausbrüchen, die um 55.500 v. Chr. aufgezeichnet wurden, und umfasst Millionen von Beobachtungen über Jahrzehnte, Länder, Systeme und Domänen hinweg. Heute zählen dazu 3,3 Millionen historische Beobachtungen neben rund 1,17 Millionen Live-Beobachtungen aus 11 kontinuierlich überwachten Strömen - darunter Bojen, Schiffe, Züge, Verkehr, Wetter, Erdbeben, Brände, Infrastruktur und geopolitische Ereignisse. Diese Beobachtungen werden in einen lebendigen Graphen aus 49.732 Knoten und 381.846 Weltgraphen-Kanten aufgelöst, der mehr als 20 Domänen umspannt. Darüber liegt eine explizite Kausalschicht mit 413 getesteten Kausal-Kanten über 54 Mehr-Schritt-Ketten, die über unsere ternäre epistemische Architektur laufend als gestützt, ungelöst oder widerlegt klassifiziert werden. Ein 1,6-Millionen-Parameter-GNN lernt Struktur aus dem Graphen und behält dabei Herkunft, Unsicherheit sowie die Unterscheidung zwischen Beobachtetem, Erschlossenem und Unbekanntem.', plain: 'DINGIR ist ein kontinuierlich wachsendes Modell der Welt.', tag: 'Weltmodell · intern' },
  ...
  causalChains: {
    ...
    chains: [
      {
        title: 'Das Erdbeben, das Lebensmittelpreise Monate später verändert',
        nodes: [
          'Erdbeben',
          'lokale Hafeninfrastruktur wird beschädigt',
          'Umschlagkapazität sinkt',
          'Schiffe werden umgeleitet',
          'Transitzeit steigt',
          'Container bleiben länger gebunden',
          'effektive globale Transportkapazität sinkt',
          'Frachtraten steigen',
          'Importkosten für ein landwirtschaftliches Input steigen',
          'regionale Produktionskosten steigen',
          'Anbauentscheidungen verschieben sich',
          'Anbaufläche ändert sich',
          'saisonale Angebotsänderung',
          'Futures-Markt reagiert',
          'Spot-Markt reagiert',
          'Lebensmittelhersteller passen Beschaffung an',
          'Verbraucherpreise ändern sich',
          'politische Preismaßnahmen',
          'fiskalische Belastung',
          'spätere Infrastrukturinvestition',
        ],
      },
      {
        title: 'Ein Starkregenereignis, das in einem Finanzsystem endet',
        nodes: [
          'Extremer Niederschlag',
          'Boden wird gesättigt',
          'Hanginstabilität steigt',
          'Straße bricht',
          'lokaler Güterverkehr sinkt',
          'Produktionsausfälle in mehreren Unternehmen',
          'Lieferfristen werden verpasst',
          'Vertragsstrafen steigen',
          'Cashflow sinkt',
          'kurzfristige Kreditnachfrage steigt',
          ...
          'kommunaler Haushalt wird enger',
          'Instandhaltung wird zurückgestellt',
          'künftige Ausfallwahrscheinlichkeit steigt',
        ],
      },
      {
        title: 'Ein Felssturz oberhalb verändert ein Delta',
        nodes: [
          'Felssturz im Oberlauf',
          'Sedimentfracht steigt',
          'Flussmorphologie ändert sich',
          'Sediment lagert sich stromabwärts ab',
          'Deltaquerschnitte verändern sich',
          'Strömung verteilt sich um',
          'Salz-/Süßwassergrenze verschiebt sich',
          'Böden werden in bestimmten Bereichen salziger',
          'landwirtschaftliche Eignung sinkt',
          'Anbaupraktiken ändern sich',
          'lokale Einkommen sinken',
          'Migration steigt',
          'Arbeitskräfteangebot ändert sich',
          'Lohngefüge ändert sich',
      ...
      {
        title: 'Ein milder Winter wird zu einem Energie- und Industrieereignis',
        nodes: [
          'Schneearme Saison',
          'Schneewasserspeicher sinken',
          'Schneeschmelze nimmt ab',
          'Zufluss zu Speichern sinkt',
          'Wasserkrafterzeugung sinkt',
          'Stromangebot sinkt',
          'thermische Reserven werden genutzt',
          'Gasnachfrage steigt',
          'Gaspreis ändert sich',
          'Strompreis ändert sich',
          'energieintensive Industrie drosselt Betriebsstunden',
          'Metallproduktion sinkt',
          'globale Vorproduktpreise ändern sich',
          'Hersteller erhöhen Preise',
          'Nachfrage verschiebt sich',
          'Investitionsplanung wird angepasst',
          'künftige Kapazitätserweiterung verzögert sich',
        ],
      },
      {
        title: 'Ein Konflikt verändert einen Industriepreis über Versicherungen',
        nodes: [
          'Konflikt eskaliert',
          'Routenrisiko steigt',
          ...
          'Transitzeit steigt',
          'verfügbare Tonnage auf Alternativrouten sinkt',
          'Frachtkosten steigen',
          'importierte Vorleistungen werden teurer',
          'Hersteller reduzieren Lagerbestände',
          'kurzfristige Produktionsstörung',
          'Spotpreis steigt',
          'Abnehmer sichern Langfristverträge ab',
          'Lieferanteninvestitionen ändern sich',
