...
export const DE: Content = {
  ...
  pricing: {
    ...
    security: [
      ...
      { tier: 'Security Retainer', hook: 'Laufende Sicherheitsabdeckung für ein Produkt, zwischen den Audits.', desc: 'Ein einzelnes Audit ist ein Foto, das an einem Tag aufgenommen wird; echte Sicherheit verschiebt sich in dem Moment, in dem Sie neuen Code ausliefern. Dieser Retainer ersetzt die Momentaufnahme durch laufende Abdeckung für ein Produkt.\n\nFür 1.500 Euro im Monat überwachen wir Ihr Produkt kontinuierlich, machen alle drei Monate einen fokussierten Delta-Check auf neue Angriffsflächen seit dem letzten Release, und stellen Sie an die Spitze der Warteschlange, sobald etwas Dringendes auftaucht.\n\nSie erhalten eine:n namentlich benannte:n Ingenieur:in, der/die Ihr System bereits kennt, damit ein Panikanruf nie damit beginnt, das eigene Setup zu erklären. Die Abdeckung beginnt innerhalb weniger Tage nach Ihrer ersten Zahlung.\n\nFür das ganze Portfolio statt eines einzelnen Produkts, mit vollem Deep-Dive-Audit statt Delta-Check: siehe Annual Intelligence Retainer weiter unten.', delivery: 'Bericht innerhalb von 7 Kalendertagen nach Audit-Abschluss.' },
