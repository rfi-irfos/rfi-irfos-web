...
export const DE: Content = {
  ...
  hero: {
    ...
    identity: 'Reguliertes österreichisches Forschungsinstitut. Ternäre KI, Sicherheit, Governance, Minderjährigenschutz und ökozentrische Technologie. Ein Team. Alles im eigenen Haus entwickelt.',
    stats: {
      ...
      pairs: [
        {
          ...
          detail: 'Tests auf Root-Ebene gegen reale Eingaben und echte Nutzer, keine Vendor-Demo und kein Benchmark-Wert.',
        },
        {
          ...
          detail: 'Dieselbe Root-Cause-Disziplin, die hinter jedem Fund steht, den wir veröffentlichen - beim ersten Symptom aufzuhören ist noch kein Fund.',
        },
        {
          q: 'Sie machen sich Sorgen wegen des AI Act und wissen nicht, wo Sie wirklich stehen?',
          a: 'Wir bewerten, wo das reale Risiko sitzt - nicht nur, worauf eine Checkliste zeigt.',
          detail: 'Kartiert gegen echte Risikoklassen und tatsächliche Datenflüsse, kein generischer Compliance-Fragebogen.',
        },
        {
          ...
          detail: 'Geliefert im selben Fünf-Fragen-Format wie jedes Audit: was wir gefunden haben, was es beweist, wie wir es bewiesen haben, wie sicher wir uns sind, was zu tun ist.',
        },
      ],
      pricingLink: 'Preise →',
    },
  ...
  appPrivacy: {
    ...
    paragraph: 'Die meisten Teams glauben, die Antwort sei Ja, weil die App jede Checkliste besteht, gegen die sie gebaut wurde. Was sie tatsächlich tut, sobald sie läuft - mit welchen SDKs sie spricht, wo die Daten landen, ob das Tracking schon beginnt, bevor jemand zugestimmt hat - ist eine andere Frage, und oft eine andere Antwort. Das ist meist der einfachste Einstiegspunkt, weil die Frage selbst leicht zu stellen ist.',
    whatWeCheckHeading: 'Was wir prüfen',
    whatWeCheck: 'Welche Berechtigungen tatsächlich angefragt und genutzt werden, wohin Daten fließen, sobald sie das Gerät verlassen, welche Dritt-SDKs eingebettet sind und was sie erhalten, sowie wann Tracking-Verhalten tatsächlich einsetzt, relativ zur Zustimmung.',
    whatYouGetHeading: 'Was Sie bekommen',
    whatYouGet: 'Eine Datenfluss-Karte dessen, was die App tatsächlich tut, eine Risikoanalyse, was das für Sie bedeutet, und die zugrunde liegenden Funde zu beidem - zuerst in klarer Sprache, technisches Detail darunter verfügbar.',
  ...
  pricing: {
    ...
    security: [
      ...
      { tier: 'Critical Infrastructure', hook: 'Prüfung mit vollem Umfang, rechtliche Absicherung und ein eingeübter Notfallplan.', desc: 'Sie erhalten eine Prüfung mit vollem Umfang unter Geheimhaltungsvereinbarung, unsere eigene Rechtsprüfung und einen mit Ihrem Team gemeinsam erarbeiteten Kommunikations-Eindämmungsplan, bevor irgendetwas schiefgeht. Für Betreiber von Energie-, Wasser-, Gesundheits- oder Verkehrsinfrastruktur ist ein Vorfall ein Ereignis der öffentlichen Sicherheit, kein IT-Ticket.\n\nWir sprechen in Ihrem Namen direkt mit jeder zuständigen Behörde. Sie erhalten ein ständiges Notfallreaktionsprotokoll, damit der schlimmste Tag im Voraus eingeübt ist und nicht spontan erfunden werden muss.\n\nWir mobilisieren innerhalb weniger Tage nach Zahlung. Das ist die Stufe für Situationen, in denen Scheitern keine Option ist.', delivery: 'Beginnt sofort nach Aufnahme; vollständiger Bericht innerhalb von 7 Kalendertagen nach Umfangsfestlegung.' },
    ...
    web: [
      { tier: 'Landing Page', hook: 'Eine schnelle, saubere Einzelseite, live innerhalb von 48 Stunden.', desc: 'Sie erhalten eine scharfe Einzelseiten-Website auf unserem eigenen Open-Source-React-Template: schnell, sauber, live innerhalb von 48 Stunden nach Zahlung.\n\nGebaut von demselben Team, das Apps auf Sicherheit prüft, also standardmäßig sauber, kein nachträglicher Gedanke.\n\nKein Page-Builder-Lock-in: Sie besitzen den Code und können ihn überallhin mitnehmen.', delivery: '48 Stunden.' },
      { tier: 'Full Site', hook: 'Eine richtige mehrseitige Website mit echtem Content-Editor, PWA-bereit.', desc: 'Sie erhalten eine richtige mehrseitige Website mit einem Content-Editor, den Ihr Team tatsächlich nutzen kann, einem funktionierenden Kontaktformular und datenschutzfreundlicher Analytik von Anfang an eingebaut.\n\nSie wird als installierbare Progressive Web App ausgeliefert und verhält sich wie eine native App auf Android und iPhone, ganz ohne App-Store-Eintrag. Geliefert in etwa zwei Wochen.\n\nGebaut von demselben Team, das Apps auf Sicherheit prüft, also standardmäßig sauber.', delivery: '14-28 Kalendertage, je nach Umfang.' },
      { tier: 'Enterprise Site', hook: 'Ein vollständiger Individualbau: Rust-Backend, Authentifizierung, native Apps inklusive.', desc: 'Sie erhalten einen vollständigen Individualbau: ein Rust-Backend, Authentifizierung und die spezifischen Integrationen, die Ihr Betrieb braucht - jede davon planen wir direkt mit Ihnen.\n\nEchte native Android- und iPhone-Apps sind inklusive, kein als App verkleideter Web-Wrapper. Langfristiger Support ist Teil des Deals, kein späterer Upsell.\n\nWir planen den Bau mit Ihnen in der ersten Woche nach Zahlung. Für Organisationen, bei denen die Website das Geschäft ist, keine Broschüre.', delivery: '14-28 Kalendertage, je nach Umfang.' },
      { tier: 'Platform Build', hook: 'Das ganze Produkt - Infrastruktur, API, native Apps - gemeinsam mit Ihnen gebaut.', desc: 'Sie erhalten ein vollständiges Produkt, nicht nur eine Website: individuelle Infrastruktur, API-Design, Datenpipelines und native Apps, mit einem festen Team, das dranbleibt.\n\nDas ist der Auftrag für den Bau der eigentlichen Plattform, nicht nur der Eingangstür dazu.\n\nWir starten innerhalb einer Woche nach Zahlung und bauen mit Ihnen weiter, während das Produkt wächst; Umfang und Zeitplan legen wir gemeinsam beim Kick-off fest, nicht im Voraus.', delivery: 'Individueller Zeitplan, nach Kick-off abgestimmt.' },
    ],
    mobile: [
  ...
  journey: {
    ...
    steps: [
      { stage: 'Kick-off', body: 'Der Umfang wird festgelegt, eine feste Ingenieur:in wird zugewiesen, und was auch immer Sie bereitstellen - ein Build, API-Zugang, ein Gerät - wird über einen sicheren Kanal ausgetauscht. Sie wissen genau, wer die Arbeit macht und wann sie beginnt.' },
      { stage: 'Analyse', body: 'Die eigentliche Untersuchung, geführt nach denselben Sources-and-Methods-Prinzipien, die für jeden Kunden gelten: Tests auf Quellebene, Root-Cause-Verfolgung, nichts wird akzeptiert, das nur eine Person reproduzieren kann.' },
      { stage: 'Review', body: 'Jeder Fund wird triagiert und nach Schwere geordnet, bevor er Sie erreicht - im selben fünfteiligen Format, das in unserer Methodologie dokumentiert ist: was wir gefunden haben, was es beweist, wie wir es bewiesen haben, wie sicher wir uns sind, was zu tun ist.' },
      { stage: 'Lieferung', body: 'Sie erhalten die Funde in dem Format, das Ihre Stufe vorsieht - zuerst eine Zusammenfassung in klarer Sprache, technisches Detail darunter - innerhalb des beim Checkout vereinbarten Lieferfensters.' },
      { stage: 'Follow-up', body: 'Sobald Fixes ausgeliefert sind, bestätigt ein Retest, dass die Lücke tatsächlich geschlossen wurde, sofern die Stufe einen solchen enthält. Bei laufenden Aufträgen beginnt hier auch der nächste Audit-Zyklus.' },
    ],
  },
