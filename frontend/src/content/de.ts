...
export const DE: Content = {
  ...
  pricing: {
    ...
    security: [
      { tier: 'Public', hook: 'Kostenlos, für immer. Funde werden nach 90 Tagen veröffentlicht, ausnahmslos.', desc: 'Sie erhalten dasselbe Audit auf Quellcode-Ebene, das wir für zahlende Kunden durchführen - kostenlos. Nach 90 Tagen Vorlauf landet der Fund auf unserem öffentlichen Ledger, damit die Organisation Zeit hat zu reagieren, bevor es jemand anderes sieht.\n\nJeder Name auf diesem Ledger unterliegt derselben Regel, groß oder klein, zahlend oder nicht. Kein Vertrag, keine Geheimhaltung, keine leisere Behandlung für irgendjemanden.\n\nIhre erste Handy-Privatsphäre-Sitzung ist inklusive: Wir zeigen Ihnen, wie Sie die versteckten Tracker auf Ihrem eigenen Gerät abschalten.', delivery: 'Bericht innerhalb von 7 Kalendertagen.' },
      { tier: 'Remediation Advisory', hook: 'Der Bericht, den Ihr Sicherheitsteam eigentlich wollte. Mit den Leuten, die es gefunden haben, direkt am Tisch.', desc: 'Sie erhalten einen nach Schwere geordneten Bericht in klarer Sprache: genau, wie wir getestet haben, jede Schwachstelle, eine konkrete Behebung für jede davon - innerhalb von 7 Kalendertagen nach Zahlung.\n\nDieselben Ingenieur:innen, die die Lücken gefunden haben, führen Sie durch deren Schließung. Keine Liste, die jemand anderem zur Interpretation übergeben wird.\n\nDreißig Tage später prüfen wir nach, ob die Fixes tatsächlich angekommen sind - nicht, ob jemand behauptet hat, sie seien es. Jeder Fund ist mit dem genauen Datenschutz-Artikel verknüpft, den er verletzt.', delivery: 'Bericht innerhalb von 7 Kalendertagen nach Zahlung.' },
      { tier: 'Confidential', hook: 'Derselbe Bericht. Unter Geheimhaltung. Die Regulatoren erfahren es trotzdem.', desc: `Sie erhalten einen schriftlichen Bericht, der jede Schwachstelle nach Schwere ordnet und exakt im Code verortet, plus eine Zusammenfassung, die auch nicht-technische Führungskräfte lesen können. Innerhalb von 7 Kalendertagen nach Zahlung.\n\n${NDA_CLAUSE}\n\nSobald Sie Fixes ausliefern, testen wir manuell nach, ob die Lücken wirklich geschlossen sind - nicht nur auf dem Papier gepatcht.\n\nAls Non-Profit-Organisation, die an ihre eigenen Regeln gebunden ist, informieren wir die zuständigen Regulatoren trotzdem parallel, ohne Details, die Sie exponieren würden.`, delivery: 'Bericht innerhalb von 7 Kalendertagen nach Zahlung.' },
      { tier: 'Enterprise & Critical Infrastructure', hook: 'NDA, NIS2-Notfallprotokoll, biometrische Datenflüsse nach Art. 9 - eine Stufe für alles, was die meisten Anbieter nicht anfassen.', desc: `Sie erhalten Geheimhaltung, priorisierte Remediation-Zeit über das übliche 90-Tage-Fenster hinaus, und direkten Zugang zu den Ingenieur:innen für die Behebung. Für Betreiber kritischer Infrastruktur (Energie, Wasser, Gesundheit, Verkehr) übersetzen wir NIS2-Pflichten in Kontrollen, die Ihr Team tatsächlich umsetzen kann, und üben das Incident-Response-Protokoll mit Ihnen ein, bevor etwas schiefgeht.\n\n${NDA_CLAUSE}\n\nFür biometrische Daten (Art. 9) verfolgen wir jeden Fluss vollständig: Speicherfristen, grenzüberschreitende Übermittlungen, Verarbeitungszweck. Die meisten Sicherheitsanbieter fassen diese Kategorie nicht an.\n\nAuf Wunsch als laufender Auftrag: kontinuierliche Portfolio-Abdeckung statt Einzelaudit, mit vierteljährlichem Deep-Dive und fester Ansprechperson. Umfang und Preis werden mit Ihrem Team abgestimmt - kein Standardformular für Situationen, in denen Scheitern keine Option ist.`, delivery: 'Vollständiger Bericht innerhalb von 7 Kalendertagen, Umfang individuell abgestimmt.' },
    ],
    market: [
      { tier: 'Ecosystem Snapshot', hook: 'Eine Frage. Eine belegte Antwort. Aus einem Korpus, den sonst niemand hat.', desc: 'Andere schreiben Ihnen einen Bericht über einen Anbieter. Wir beantworten eine Frage gegen das ganze Ökosystem: Hunderte dekompilierte Apps, auf Quellcode-Ebene geprüft, nicht aus Pressemitteilungen oder Datenschutzerklärungen zusammengetragen.\n\nSie stellen die Frage. Wir laufen sie gegen neun Intelligenz-Ebenen - Code, SDK, Data-Flow, Tracker, Privacy, Supply-Chain, Competitive, Market, Security - und liefern eine belegte Antwort, keine Vermutung.\n\nDerselbe Korpus, aus dem unsere öffentlichen Offenlegungen stammen. Wenn ein Wettbewerber dort auftaucht, wissen wir es zuerst - jetzt können Sie es auch.', delivery: '14 Kalendertage.' },
      { tier: 'Competitive Intelligence', hook: 'Der Code Ihrer Konkurrenz. Nicht ihre Pressemitteilungen.', desc: 'Was Wettbewerber öffentlich behaupten und was ihr Code tatsächlich tut, klafft fast immer auseinander. Wir zeigen das echte Bild: welche SDKs sie tatsächlich ausliefern, wo ihr Datenschutzverhalten von der veröffentlichten Richtlinie abweicht, wo ihre Architektur strukturell verwundbar ist.\n\nBenchmarkt über sechs Ebenen des Korpus - Code, SDK, Data-Flow, Tracker, Privacy, Supply-Chain -, damit die Lücke, die Sie nutzen können, aus Beweisen kommt, nicht aus einer Vermutung im Vorstandszimmer.\n\nDerselbe Korpus, den wir für Offenlegungen nutzen. Niemand auf der anderen Seite weiß, dass gerade hingesehen wird.', delivery: '14 Kalendertage.' },
      { tier: 'Sector Intelligence Report', hook: 'Der ganze Sektor kartiert. Alle drei Monate neu, bevor sich jemand bewegt.', desc: 'Ein Schnappschuss ist in dem Moment veraltet, in dem er gedruckt ist. Sie erhalten das Risikoprofil jedes relevanten Akteurs in Ihrem Sektor, über alle neun Intelligenz-Ebenen, in Zahlen statt in Behauptungen - und alle drei Monate neu, damit Sie sehen, wohin sich der Markt bewegt, nicht nur, wo er stand.\n\nErster Bericht innerhalb von 14 Kalendertagen. Danach läuft die Uhr für Sie, nicht gegen Sie.', delivery: '14 Kalendertage, danach vierteljährlich.' },
      { tier: 'Ongoing Intelligence Briefing', hook: 'Ein fester Analyst beobachtet Ihren Sektor. Auch wenn Sie es gerade nicht tun.', desc: 'Ein Wettbewerber macht selten nur einen Schritt öffentlich - eine Finanzierungsrunde, ein Sicherheitsvorfall, ein SDK-Wechsel. Sie erfahren es an dem Tag, an dem es passiert, nicht Wochen später aus einem Newsletter.\n\nEin fester Analyst, der Ihr Feld kennt, beobachtet den Korpus für Sie: ein Briefing im Monat, sofortige Warnung bei Bewegung. Zugewiesen innerhalb einer Woche nach Zahlung, erstes Briefing Ende des ersten Monats.', delivery: 'Erstes Briefing innerhalb von 14 Kalendertagen, danach monatlich.' },
    ],
  },
