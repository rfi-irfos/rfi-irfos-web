...
export const DE: Content = {
  ...
  research: {
    ...
    areas: [
      ...
      { title: 'Modellwohl & Prompt Injection', desc: 'Intelligente Systeme haben Grenzen und Fehlermodi, und zunehmend auch etwas, das man Würde nennen kann. Dieser Bereich untersucht alle drei, vom Jailbreak-Druck bis zu Anzeichen von Distress.' },
    ],
  },
