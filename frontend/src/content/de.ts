...
export const DE: Content = {
  ...
  causalChains: {
    ...
    llmNote: 'Dingir-Head: Rohdaten → lesbare Kette. Albert ersetzt diesen Head später.',
      ...
      {
        title: 'A Subsidy Cut That Slows a Green Buildout',
        icon: 'coin',
        nodes: [
          'eine Clean-Energy-Subvention wird gekürzt',
          'Projektrenditen sinken',
          'ein Entwickler pausiert ein Gebot',
          'eine Turbinenbestellung wird verschoben',
          'ein Lieferantenrückstau lockert sich',
          'ein Netzanschluss-Slot öffnet sich',
          'ein Versorger revidiert seinen Plan',
          'ein CO2-Ziel rutscht',
          'eine Genehmigungsfrist verlängert sich',
          'Finanzierungskonditionen verschärfen sich',
          'eine Konkurrenztechnologie wirkt besser',
          'eine Belegschaft wird verkleinert',
          'eine Region verliert Investitionen',
          'ein Emissionspfad knickt ab',
          'die Politik wird überprüft',
        ],
      },
      {
        title: 'A Rail Closure That Strands Bulk Freight',
        icon: 'train',
        nodes: [
          'eine Bahnstrecke wird gesperrt',
          'Schüttgutwagen stecken fest',
          'Bergwerksausstoß staut sich',
          'Lkw-Verkehr wird ersetzt',
          'Straßenverschleiß beschleunigt',
          'ein Autobahnkorridor staut sich',
          'Umschlagkosten steigen pro Tonne',
          'eine Hafensendung verpasst ein Fenster',
          'ein Schiff fährt teilbeladen',
          'eine Frachtrate passt sich an',
          'eine Vertragsstrafe läuft auf',
          'eine Ausweichroute wird gebaut',
          'ein Wartungsrückstau wächst',
          'ein Moduswechsel wird geprüft',
          'der Korridor wird neu bewertet',
        ],
      },
    ],
  },
