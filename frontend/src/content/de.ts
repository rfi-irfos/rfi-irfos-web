...
export const DE: Content = {
  ...
  pricing: {
    ...
    security: [
      ...
      { tier: 'Remediation Advisory', hook: 'Keine PDF von der Stange. Eine Untersuchung mit unserer Methode gegen unseren Korpus.', desc: 'Sie bezahlen nicht für ein Dokument. Sie beauftragen eine Untersuchung mit unserer Methodik, unserem Korpus dekompilierter Apps und unserer Quellen-Architektur - exakt der, mit der wir Funde auf dem öffentlichen Ledger ablegen. Das Ergebnis ist ein nach Schwere geordneter Befund: genau, wie wir getestet haben, jede Schwachstelle, eine konkrete Behebung für jede davon - innerhalb von 7 Kalendertagen.\n\nDieselben Ingenieur:innen, die die Lücken gefunden haben, führen Sie durch deren Schließung. Keine Liste, die jemand anderem zur Interpretation übergeben wird.\n\nDreißig Tage später prüfen wir nach, ob die Fixes tatsächlich angekommen sind - nicht, ob jemand behauptet hat, sie seien es. Jeder Fund ist mit dem genauen Datenschutz-Artikel verknüpft, den er verletzt.', delivery: 'Befund innerhalb von 7 Kalendertagen nach Zahlung.' },
      { tier: 'Confidential', hook: 'Dieselbe Untersuchung. Unter Geheimhaltung. Die Regulatoren erfahren es trotzdem.', desc: `Sie beauftragen dieselbe Untersuchung gegen unseren Korpus - mit Geheimhaltung. Das Ergebnis: ein Befund, der jede Schwachstelle nach Schwere ordnet und exakt im Code verortet, plus eine Zusammenfassung, die auch nicht-technische Führungskräfte lesen können. Innerhalb von 7 Kalendertagen.\n\n${NDA_CLAUSE}\n\nSobald Sie Fixes ausliefern, testen wir manuell nach, ob die Lücken wirklich geschlossen sind - nicht nur auf dem Papier gepatcht.\n\nAls Non-Profit-Organisation, die an ihre eigenen Regeln gebunden ist, informieren wir die zuständigen Regulatoren trotzdem parallel, ohne Details, die Sie exponieren würden.`, delivery: 'Befund innerhalb von 7 Kalendertagen nach Zahlung.' },
