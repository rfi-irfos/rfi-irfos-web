...
export const DE: Content = {
  ...
  research: {
    ...
    areas: [
      { title: 'Ethik & Minderjährigenschutz', desc: 'Wir prüfen Einwilligung, Würde und Exposition in Systemen, die um Menschen herum gebaut werden, die sich nicht vollständig selbst schützen können — allen voran Kinder und Jugendliche: Plattformen, biometrische und Verhaltensdaten und die Systeme, die darum gebaut werden.' },
      { title: 'Ternäre KI & Computing', desc: 'Wir bauen post-binäre Arithmetik als native Grundlage in Sprachmodelle, Compiler und Betriebssysteme ein, nicht als nachträgliche Ergänzung. Patent angemeldet A50296/2026.' },
      { title: 'Weltmodelle & domänenübergreifende Intelligenz', desc: 'Wir bauen ein gemeinsames Modell für Entitäten, Beziehungen, Evidenz und Veränderung über Domänen hinweg, die sonst getrennt betrachtet werden — damit sich eine Verschiebung in einem System dorthin zurückverfolgen lässt, wo sie tatsächlich mit einem anderen zusammenhängt.' },
      { title: 'Mustererkennung & Wirkungsausbreitung', desc: 'Wir finden wiederkehrende Strukturen über Domänen hinweg und verfolgen, wie sich eine Veränderung durch Abhängigkeiten, Brücken, Engpässe und verbundene Systeme bewegt.' },
      { title: 'Veränderungs- & Anomalieerkennung', desc: 'Wir beobachten Systeme über die Zeit, um zu erkennen, was sich verschoben hat, was ungewöhnlich ist und welche Übergänge tatsächlich Aufmerksamkeit verdienen.' },
      { title: 'Szenariensimulation & Kontrafaktik', desc: 'Wir simulieren Interventionen, alternative Zukünfte und ihre propagierten Konsequenzen — ausdrücklich als Simulation markiert und nie mit Beobachtung verwechselt.' },
      { title: 'Evidenz & Widerspruch', desc: 'Wir halten stützende Evidenz, widersprechende Evidenz, Provenance, Konfidenz und offene Fragen zusammen, statt sie vorschnell zu einem Urteil einzuebnen.' },
      { title: 'Modellwohl & Prompt Injection', desc: 'Wir untersuchen Verhalten, Grenzen, Fehlermodi und Würde intelligenter Systeme — vom Jailbreak-Druck bis zu Anzeichen von Distress.' },
    ],
  },
