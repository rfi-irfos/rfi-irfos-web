...
export const DE: Content = {
  ...
  research: {
    ...
    areas: [
      ...
      { title: 'Weltmodelle & domänenübergreifende Intelligenz', desc: 'Die meisten Systeme, die Entitäten, Beziehungen, Evidenz und Veränderung untersuchen, halten ihre Domänen getrennt. Unseres nicht: ein gemeinsames Modell, damit sich eine Verschiebung in einem System dorthin zurückverfolgen lässt, wo sie tatsächlich mit einem anderen zusammenhängt.' },
      { title: 'Mustererkennung & Wirkungsausbreitung', desc: 'Eine Veränderung bleibt selten dort, wo sie beginnt — sie bewegt sich durch Abhängigkeiten, Brücken, Engpässe und jedes verbundene System dahinter. Genau diese wiederkehrenden Strukturen über Domänen hinweg zu finden, ist die Aufgabe dieses Forschungsbereichs.' },
      ...
      { title: 'Evidenz & Widerspruch', desc: 'Echte Evidenz stimmt selten mit sich selbst überein. Stützende Aussagen, widersprechende Aussagen, Provenance, Konfidenz und offene Fragen bleiben hier zusammen, statt vorschnell zu einem Urteil eingeebnet zu werden.' },
      { title: 'Modellwohl & Prompt Injection', desc: 'Intelligente Systeme haben Grenzen, Fehlermodi und — zunehmend — etwas, das man Würde nennen kann. Dieser Bereich untersucht alle drei, vom Jailbreak-Druck bis zu Anzeichen von Distress.' },
    ],
  },
