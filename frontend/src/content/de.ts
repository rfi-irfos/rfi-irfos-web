...
export const DE: Content = {
  ...
  pricing: {
    ...
    market: [
      { tier: 'First Light', hook: 'Wissen, bevor es öffentlich ist. Eine Query, Hunderte Apps, eine Antwort, die sonst niemand ziehen kann.', desc: 'Während Ihre Konkurrenz auf eine Pressemitteilung wartet, wissen Sie es schon. Wir beantworten eine Frage gegen den vollständigen dekompilierten App-Korpus - kein Dokument über einen Anbieter, eine Live-Query gegen das ganze Ökosystem.\n\nNeun Intelligenz-Ebenen laufen hinter jeder Antwort: Code, SDK, Data-Flow, Tracker, Privacy, Supply-Chain, Competitive, Market, Security. Keine Meinungen, kein Marketingtext. Was der Code tatsächlich tut, jetzt gerade.\n\nDerselbe Korpus, aus dem unsere öffentlichen Offenlegungen stammen. Wenn sich irgendwo etwas zusammenbraut, sehen wir es entstehen, bevor es zur Schlagzeile wird - und Sie auch.', delivery: '14 Kalendertage.' },
      { tier: 'Competitive Trace', hook: 'Den Schritt sehen, bevor er angekündigt wird.', desc: 'Wenn die Kurskorrektur eines Wettbewerbers in der Presse landet, steckt sie oft schon monatelang im Code. Wir lesen den Code zuerst: welche SDKs tatsächlich ausgeliefert werden, wo das Datenschutzverhalten von der veröffentlichten Richtlinie abweicht, wo sich die Architektur still verändert.\n\nBenchmarkt über sechs Ebenen des Korpus - Code, SDK, Data-Flow, Tracker, Privacy, Supply-Chain -, damit Sie auf Beweisen handeln, während andere noch im Vorstandszimmer spekulieren.\n\nDerselbe Korpus, den wir für Offenlegungen nutzen. Die andere Seite hat keine Ahnung, dass gerade hingesehen wird.', delivery: '14 Kalendertage.' },
      { tier: 'Sector Map', hook: 'Der ganze Sektor kartiert und aktualisiert, bevor die Konkurrenz merkt, dass sich der Boden bewegt hat.', desc: 'Ein Schnappschuss ist in dem Moment veraltet, in dem er gedruckt ist. Sie erhalten das Risikoprofil jedes relevanten Akteurs in Ihrem Sektor, über alle neun Intelligenz-Ebenen, alle drei Monate neu - damit Sie die Verschiebung sehen, während sie noch entsteht, nicht nachdem sie längst eingepreist ist.\n\nErster Bericht innerhalb von 14 Kalendertagen. Danach liegen Sie dem Sektor immer drei Monate voraus, während andere noch den Marktbericht vom letzten Jahr lesen.', delivery: '14 Kalendertage, danach vierteljährlich.' },
      { tier: 'Signal', hook: 'Ein stehendes Frühwarnsystem für Ihren Sektor. Damit Sie nie die oder der Letzte sind, der es erfährt.', desc: 'Ein Wettbewerber macht selten einen öffentlichen Schritt, ohne dass monatelang Signale davor sichtbar waren - eine Finanzierungsrunde, ein Sicherheitsvorfall, ein SDK-Wechsel, eine stille Kurskorrektur im Code. Sie bekommen die Warnung, sobald das Signal auftaucht, nicht die Schlagzeile Wochen später.\n\nEin fester Analyst beobachtet den Korpus für Ihren Sektor kontinuierlich: ein Briefing im Monat, sofortige Warnung bei Bewegung. Zugewiesen innerhalb einer Woche nach Zahlung.', delivery: 'Erstes Briefing innerhalb von 14 Kalendertagen, danach monatlich.' },
    ],
    technical: [
