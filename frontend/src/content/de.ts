...
export const DE: Content = {
  ...
  appPrivacy: {
    ...
    comparisonClassicLabel: 'Typische App-Prüfung',
    comparisonRfiLabel: 'RFI',
    comparisonRows: [
      { classic: 'Liest die Datenschutzerklärung', rfi: 'Liest, was der Code tatsächlich tut' },
      { classic: 'Prüft, welche Berechtigungen angefragt werden', rfi: 'Prüft, welche Berechtigungen tatsächlich genutzt werden' },
      { classic: 'Vertraut der Compliance-Aussage des Anbieters', rfi: 'Verfolgt, wohin die Daten jedes SDKs tatsächlich gehen' },
      { classic: 'Eine einmalige Momentaufnahme', rfi: 'Reproduzierbare, zeitgestempelte Belege' },
      { classic: 'Ein Bestanden/Durchgefallen-Ergebnis', rfi: 'Ein Bericht in klarer Sprache, technisches Detail darunter' },
    ],
