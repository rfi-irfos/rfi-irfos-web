...
export const DE: Content = {
  ...
  research: {
    ...
    areas: [
      ...
      { title: 'Veränderungs- & Anomalieerkennung', plain: 'Ein Schifffahrtskorridor entwickelt ein Verspätungsmuster, das noch niemand erklärt hat. Eine Flut an einem Ort teilt ihre erfasste Ursache plötzlich mit drei anderen, einen Ozean entfernt, die bisher niemand verbunden hatte. Eine App fragt eine Berechtigung stillschweigend nicht mehr ab. Nichts davon wird angekündigt - unser System merkt es in dem Moment, in dem sich das Muster verschiebt, egal wo.', desc: 'Das Meiste, was am Ende wirklich zählt, beginnt klein genug, um es zu übersehen: eine Schifffahrtsroute, die langsamer läuft als ihre eigene Geschichte, ein Ursachencode, den Katastrophen teilen, die noch nie zuvor verbunden wurden, eine Berechtigung, die plötzlich nicht mehr nachfragt. Genau der Moment, in dem etwas "wahrscheinlich in Ordnung" aussieht, verdient einen zweiten Blick, denn genau dann schaut sonst niemand mehr hin.\n\nUnsere eigene Pipeline folgt demselben Reflex, auf jeder Ebene, auf der die Daten liegen: ein Knoten, dessen Position im Graphen weit von allem Vergleichbaren abweicht, eine Richtlinien-Änderung, die es wert ist, nochmal gelesen zu werden, ein neu gezogener Build, der gegen den letzten geprüften abgeglichen wird - derselbe strukturelle Check, ob er Katastrophenberichte, Sanktionslisten oder eine stillschweigend verschwundene Berechtigung liest, bevor ein Mensch es von Hand bemerken müsste.', nextLabel: 'Was die Verschiebung als Nächstes bedeuten könnte' },
