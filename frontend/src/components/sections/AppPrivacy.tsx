...
export function AppPrivacySection() {
  ...
  return (
    <section id="app-privacy" style={{ padding: '48px var(--sec-pad-x) 48px' }}>
      ...
      <div style={{ maxWidth: 1320, margin: '0 auto' }}>
        ...
        <Reveal from="bottom" delay={2}>
          {/* Button vertically centered between table above and CoopPartners below:
          ...
          <div style={{ textAlign: 'center', marginTop: 28, marginBottom: 0 }}>
