...
const AUDIT_HIGHLIGHTS = [
  ...
  { target: 'Last War: Survival',   market: 'PRIVATE', sev: 'CRITICAL', status: 'ACK',         finding: 'com.fun.lastwar.gp. FunPlus International AG (Beijing/Switzerland). Chinese parent = NatIntelLaw Art. 7 risk. support@lastwar.com rubber stamp loop x2 ("Dear Commander") — automated CS, no DPO path visible. Pattern 1.' },
  ...
  { target: 'Too Good To Go',       market: 'PRIVATE', sev: 'HIGH',     status: 'ACK',         finding: 'com.app.tgtg. Food rescue platform (75M+ users). Firebase + AppsFlyer + Braze stack. privacy+canned.response@toogoodtogo.com canned reply — "please review our privacy policy at..." — Pattern 1 Policy-as-Implementation-Proof. R2 pending.' },
