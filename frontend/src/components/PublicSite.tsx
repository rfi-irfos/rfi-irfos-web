      ...
      <section id="pricing" style={{ padding: '100px 2rem' }}>
        <div style={{ maxWidth: 1320, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: 16, marginBottom: 48 }}>
            {([
              { tier: 'Public',                   price: 'free',      desc: 'Completely free, and completely open. When we check an app or a company, we publish what we find after a 90-day heads-up window, so the organization has time to fix the problem before anyone else sees it.\n\nWe hold every name on our public ledger to that exact same rule, big or small, paying or not. There is no contract, no secrecy agreement, and no hidden catch.\n\nAs a bonus, your very first phone privacy session is on us: we show you, step by step, how to switch off the hidden trackers running in the background of your own phone. This is our standing promise to the public, not a trial that ends.', highlight: false, stripeKey: null,            directUrl: null, contact: false },
              { tier: 'Security Retainer',        price: '€1,500 / mo', desc: 'A single audit is like a photo taken on one day. Real security drifts the moment you ship new code, so this is an ongoing watch, not a snapshot. For 1,500 euros a month we keep an eye on your product between audits, run a proper deep-dive every three months, and jump to the front of the line the instant something urgent appears.\n\nYou also get one named person who already knows how your system is built, so you never have to explain your setup from scratch during a panic call.\n\nThink of it as a standing security team you can call any time, without hiring anyone.', highlight: false, stripeKey: 'retainer', directUrl: null, contact: false },
              { tier: 'Remediation Advisory',     price: '€4,500',    desc: 'You receive the full written report, but the part that matters most is that the very engineers who found the holes walk you through how to actually close them. This is not just a list of problems to hand to someone else.\n\nThirty days later we check back to confirm the fixes genuinely landed, not only that someone claimed they did. And because we are a regulated institute, every finding is tied to the exact privacy law article it breaks, so your legal team gets a clear map instead of a mystery.\n\nThis is the difference between having a report and being truly fixed.',                                        highlight: false, stripeKey: 'remediation',   directUrl: null, contact: false },
              { tier: 'Confidential',             price: '€9,000',    desc: 'Everything stays private between you and us under a strict secrecy agreement. Your customers and the public never see the findings. You still get the detailed report, and we check the fixes by hand once you ship them, so you know the repair is real and not just a promise.\n\nThe one thing we cannot drop: because we are a not-for-profit bound by our own rules, the relevant regulators are told in parallel.\n\nSo you get discretion where it matters and proof where it counts, without us breaking our duty to the public.',                                        highlight: false, stripeKey: 'confidential',  directUrl: null, contact: false },
              { tier: 'Enterprise NDA',           price: '€18,000',   desc: 'Same privacy as the Confidential tier, but with a longer runway. We stretch the embargo well past our standard 90 days, so your team has real time to fix things properly instead of rushing a patch over a weekend.\n\nYou work directly with our engineers on the repair, your lawyers receive a complete evidence package they can hand straight to counsel, and any follow-up jumps the queue.\n\nBuilt for larger organizations where fixing everything in 90 days is simply not realistic.', highlight: false, stripeKey: 'enterprise_nda', directUrl: null, contact: false },
              { tier: 'Critical Infrastructure',  price: '€75,000',   desc: 'For operators of critical infrastructure, things like energy, water, health care, and transport, a breach is not an IT problem, it is a public-safety event.\n\nWe go full-scope under a secrecy agreement, bring in our own legal review, and build the public-relations containment plan together with your communications team before anything goes wrong. We talk directly to every relevant authority on your behalf, and you receive a standing emergency-response protocol, so the worst day is rehearsed in advance instead of invented on the spot.\n\nThis is the tier for situations where failure is simply not an option.', highlight: true,  stripeKey: 'critical_infra', directUrl: 'https://buy.stripe.com/9B66oJ6OIbU32LPcHK7N60H', contact: false },
              { tier: 'IoB / Art. 9',             price: '€150,000',  desc: 'Internet-of-Bodies products, meaning wearables and implants that handle health data, fall under the strictest privacy category in European law.\n\nThe 150,000 euros reflects the depth of the work: we trace every flow of biometric data, every period your data is kept, and every transfer across borders, and we keep the same secrecy agreement and regulator contact as the Enterprise tier.\n\nMost security shops will not touch this category at all. We specialize in it, because the data here is literally about people bodies.', highlight: true,  stripeKey: 'iob_art9', directUrl: 'https://buy.stripe.com/4gMcN7ehagaj4TXcHK7N60G', contact: false },
              { tier: 'Annual Intelligence Retainer', price: '€250,000', desc: 'Our flagship engagement. For a full year we watch your entire app portfolio without pause, not a sample but all of it, with deep audits every three months.\n\nYou get a dedicated contact who speaks directly to the regulators that matter, from the Austrian and German data protection authorities to the UK watchdog, a threat briefing every month so nothing catches you by surprise, and instant notice the moment we see a breach taking shape.\n\nThis is the tier where we act as your external security and compliance department.', highlight: true, stripeKey: 'annual_retainer', directUrl: 'https://buy.stripe.com/00wcN71uo4rBdqt7nq7N60I', contact: false },
            ] as const).map((t, i) => (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 220px), 1fr))', gap: 16, marginBottom: 48 }}>
            {[
              { tier: 'Market Overview',          price: '€2,500',      stripeKey: 'market_overview',  desc: 'A clear, plain-language map of your sector: who the key players are, how the rules and regulations actually work for them, and where the real openings sit.\n\nAt least ten pages, delivered within five business days. No jargon and no two-hundred-slide deck, just the landscape you need to make a decision, written so a founder can read it in one sitting.' },
              { tier: 'Competitor Intelligence',    price: '€7,500',      stripeKey: 'competitor_intel', desc: 'We take apart three to five of your competitors: what technology they are built on, how they actually treat user privacy, which is often very different from what they claim, how they position themselves in the market, and where they are strategically weak.\n\nYou receive a realistic picture of the field, including the gaps you can exploit and the ones you need to close.\n\nThis is the homework most teams skip and later regret.' },
              { tier: 'Sector Intelligence Report', price: '€18,000',     stripeKey: 'sector_intel',     desc: 'The complete picture: the market, the regulations, and the technology across your whole sector, with each major player risk exposure spelled out in numbers rather than vague claims.\n\nAnd because markets move, this is not a one-off document, you receive a fresh update every three months.\n\nBy the end you know exactly where the sector is heading and which players are exposed, so your strategy rests on evidence instead of guesswork.' },
              { tier: 'Ongoing Intelligence Briefing', price: '€4,500 / mo', stripeKey: 'ongoing_intel', desc: 'We keep watching your competitors so you do not have to. Continuous tracking, a proper briefing every month, and an immediate alert the moment one of them makes a significant move, whether that is a funding round, a pivot, a breach, or a key hire.\n\nYou get one dedicated analyst who knows your space.\n\nThis is the difference between reading about a competitor big launch after the fact and hearing about it on the day it happens.' },
            ].map((t, i) => (
              <Reveal key={t.tier} delay={i % 4} from={(['left','bottom','right','scale'] as const)[i % 4]}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 220px), 1fr))', gap: 16, marginBottom: 64 }}>
            {[
              { tier: 'Landing Page',   price: '€1,500',  stripeKey: 'web_landing'   as string | null, desc: 'A sharp single-page site built on React with our own open-source template, fast, clean, and live within forty-eight hours.\n\nPerfect for a launch, an event, or a product that only needs one great page.\n\nNo bloated page builder and no lock-in: you own the code and can take it anywhere.' },
              { tier: 'Full Site',      price: '€4,500',  stripeKey: 'web_full'      as string | null, desc: 'A proper multi-page site with a content editor your team can actually use, a working contact form, and privacy-respecting analytics built in from the start.\n\nIt ships as an installable progressive web app, which means it behaves like a native app on phones, both Android and iPhone, without going through an app store. Delivered in about two weeks.\n\nBuilt by the same people who audit apps for a living, so it is clean by default.' },
              { tier: 'Enterprise Site',price: '€18,000', stripeKey: 'web_enterprise' as string | null, desc: 'A full custom build: a Rust backend, login and authentication, the integrations you need, and whatever scope your operation requires.\n\nIt includes real native Android and iPhone apps, not a web wrapper dressed up as one. Long-term support is part of the deal, not an extra charge.\n\nFor organizations where the website is the business itself, not a brochure.' },
              { tier: 'Platform Build', price: '€75,000', stripeKey: null,                              desc: 'A complete product, not just a site: custom infrastructure, API design, data pipelines, native apps, and a dedicated team that stays with it.\n\nThis is the engagement for when you are building the actual platform, not only the front door to it.\n\nIt is ongoing, not a handoff, we build it and keep building it together with you as the product grows.' },
            ].map((t, i) => (
              <Reveal key={t.tier} delay={i % 4} from={(['left','bottom','right','scale'] as const)[i % 4]}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 220px), 1fr))', gap: 16, marginBottom: 64 }}>
            {[
              { tier: 'Maintenance Retainer',  price: '€1,200 / mo', desc: 'We keep your app healthy month to month: a steady rhythm of patches, watching the app-store compliance rules so you are not pulled for a policy change you missed, and keeping your code libraries and tracking tools clean so old dependencies do not become tomorrow problem.\n\nPriority response and one named contact.\n\nQuiet, continuous upkeep so your app does not silently rot.' },
              { tier: 'APK Review & Bugfix',  price: 'from €1,500', desc: 'Send us your app build and we go to the root level: we read the actual code, not only the marketing.\n\nWe sort crashes and real weak spots, then hand you concrete guidance on how to fix each one. It works for both Android and iPhone. Fixed scope, one-week turnaround, you get a clear answer fast instead of a six-week audit you were not braced for.' },
              { tier: 'App Build',            price: 'from €9,000', desc: 'We build your native app from zero to shipped: Kotlin for Android, Swift for iPhone, with a Rust backend underneath.\n\nNo offshore handoff, everything done in-house by the team you are already talking to. We also handle the Play Store and App Store submission, which is exactly where most builds stall.\n\nOne team, one codebase, one launch.' },
              { tier: 'Full Mobile Product',   price: 'on request',  desc: 'The whole mobile product, from a spec on a napkin to a launched app: custom infrastructure, API design, native apps, and a dedicated team that stays on it.\n\nOngoing engagement, because a real product keeps evolving after launch.\n\nFor when you need a mobile business built, not only an app made.' },
            ].map((t, i) => (
              <Reveal key={t.tier} delay={i % 4} from={(['left','bottom','right','scale'] as const)[i % 4]}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 260px), 1fr))', gap: 16, marginBottom: 48 }}>
            <Reveal from="right">
              <PriceTierCard tier="Phone Sanitizing" price="free"
                onProposal={() => openProposalModal({ tier: 'Phone Sanitizing', price: 'free', desc: 'Your first privacy session is free. Send us your phone and we permanently switch off the background tracking scripts most apps quietly run, move you to encrypted name lookup, and harden your backups.\n\nYou get a full before-and-after report showing exactly what was talking to whom.\n\nBy appointment, no charge, this is part of our public mission.' })} />
            </Reveal>
          </div>
