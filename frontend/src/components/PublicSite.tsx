      ...
      <section id="pricing" style={{ padding: '100px 2rem' }}>
        <div style={{ maxWidth: 1320, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 220px), 1fr))', gap: 16, marginBottom: 48 }}>
            {[
              { tier: 'Market Overview',          price: '€2,500',      stripeKey: 'market_overview',  delivery: '', desc: 'You get a clear, plain-language map of your sector delivered within five business days: who the key players are, how the rules and regulations actually work for them, and where the real openings sit.\n\nIt runs at least ten pages, with no jargon and no two-hundred-slide deck, just the landscape you need to make a decision, written so a founder can read it in one sitting.\n\nWe start the research within a few days of payment and send the finished report inside five business days.' },
              { tier: 'Competitor Intelligence',    price: '€7,500',      stripeKey: 'competitor_intel', delivery: '', desc: 'You get three to five of your competitors taken apart: what technology they are built on, how they actually treat user privacy, which is often very different from what they claim, how they position themselves, and where they are strategically weak.\n\nThe result is a realistic picture of the field, including the gaps you can exploit and the ones you need to close. This is the homework most teams skip and later regret.\n\nWe deliver within ten business days of payment.' },
              { tier: 'Sector Intelligence Report', price: '€18,000',     stripeKey: 'sector_intel',     delivery: '', desc: 'You get the complete picture of your sector: the market, the regulations, and the technology, with each major player risk exposure spelled out in numbers rather than vague claims.\n\nBecause markets move, this is not a one-off document, you receive a fresh update every three months, so you always know where the sector is heading and which players are exposed.\n\nWe deliver the first report within two weeks of payment, then refresh it every quarter.' },
              { tier: 'Ongoing Intelligence Briefing', price: '€4,500 / mo', stripeKey: 'ongoing_intel', delivery: '', desc: 'You get continuous watching of your competitors so you do not have to: a proper briefing every month, and an immediate alert the moment one of them makes a significant move, whether that is a funding round, a pivot, a breach, or a key hire.\n\nOne dedicated analyst who knows your space handles it, so you hear about a competitor big launch on the day it happens, not after.\n\nWe assign your analyst within a week of payment and the first briefing lands at the end of month one.' },
            ].map((t, i) => (
              <Reveal key={t.tier} delay={i % 4} from={(['left','bottom','right','scale'] as const)[i % 4]}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 220px), 1fr))', gap: 16, marginBottom: 64 }}>
            {[
              { tier: 'Landing Page',   price: '€1,500',  stripeKey: 'web_landing'   as string | null, delivery: '48 Stunden.', desc: 'You get a sharp single-page site built on our own open-source React template, fast, clean, and live within forty-eight hours of payment.\n\nIt is perfect for a launch, an event, or a product that only needs one great page.\n\nNo bloated page builder and no lock-in: you own the code and can take it anywhere.' },
          ...
          <Reveal from="bottom" delay={1}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: mobile ? '1fr' : 'repeat(auto-fit, minmax(200px, 1fr))', gap: 10, marginTop: 16 }}>
              {[
                ...
                <button key={i}
                  onClick={() => openCheckoutModal({ key: `coop_${i}`, tier: p.name, desc: p.desc, price: p.price, delivery: `Answered within 24h after purchase; kickoff aligned on request.`, directUrl: p.href })}
                  style={{
